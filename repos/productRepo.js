...
exports.add=(c)=>{
    var sql= `INSERT INTO 'may_anh' ('ma_may_anh', 'ten_may_anh', 'gia', 'duong_dan', 'ma_loai', ma_ncc', 'ma_nsx', 'so_luong', 'ngay_nhap', 'mo_ta', 'xuat_xu') VALUES ('${c.ProductName}', ${c.ProductPrice}, '${c.ProductLink}', ${c.ProductCat}, ${c.ProductSupplier}, ${c.ProductProducer}, ${c.ProductNumber}, ${c.ProductDate}, '${c.ProductDescribe}', '${c.Origin}')`;
    return db.save(sql);
}
...
exports.update =  (c) =>{
    var sql=`UPDATE 'may_anh' SET 'ten_may_anh' = '${c.ProductName}' 'gia' = ${c.ProductPrice} 'duong_dan'=${c.ProductLink} 'ma_loai'=${c.ProductCat} ' 'ma_ncc'=${c.ProductSupplier} 'ma_nsx'=${c.ProductProducer} ' 'so_luong'=${c.ProductNumber} 'ngay_nhap'=${c.ProductDate} 'mo_ta'=${c.ProductDescribe} 'xuat_xu'=${c.ProductOrigin} WHERE 'may_anh'.'ma_may_anh' = ${c.id}`;
    return db.save(sql);
}